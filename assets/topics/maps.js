...
window.topics.push({
  id: 'maps',
  title: 'Maps',
  desc: 'Map examples: literals, key access, the value, ok idiom, iteration, and delete.',
  code: `package main
...
func main() {
    ...
    // Without initialization -> nil map
    var arr2 [4]int
    var sl2 []int
